...
./ip/ip link set pbbi_0 type pbbi c-vid 200 c-vid-mode-strip s-vid 20 s-vid-mode-strip i-sid 20000 i-sid-type-excl
./ip/ip link set pbbi_0 type pbbi c-vid 200 c-vid-mode-strip s-vid 20 s-vid-mode-strip i-sid 20000 i-sid-type-excl key-info-map-verify
...
./ip/ip link set pbbi_1 type pbbi c-vid 200 c-vid-mode-strip s-vid 20 s-vid-mode-strip i-sid 20000 i-sid-type-excl
./ip/ip link set pbbi_1 type pbbi c-vid 200 c-vid-mode-strip s-vid 20 s-vid-mode-strip i-sid 20000 i-sid-type-excl key-info-map-verify
