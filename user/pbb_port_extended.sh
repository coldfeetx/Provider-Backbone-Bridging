...
./ip/ip link set pbbi_0 type pbbi c-vid 0 c-vid-mode-strip s-vid 0 s-vid-mode-strip i-sid 20000 i-sid-type-excl
./ip/ip link set pbbi_0 type pbbi c-vid 0 c-vid-mode-strip s-vid 0 s-vid-mode-strip i-sid 20000 i-sid-type-excl key-info-map-verify
...
./ip/ip link set pbbi_1 type pbbi c-vid 0 c-vid-mode-strip s-vid 0 s-vid-mode-strip i-sid 20000 i-sid-type-excl
./ip/ip link set pbbi_1 type pbbi c-vid 0 c-vid-mode-strip s-vid 0 s-vid-mode-strip i-sid 20000 i-sid-type-excl key-info-map-verify
...
modprobe 8021q
./ip/ip netns exec netedge1 ifconfig veth0 up
./ip/ip netns exec netedge1 ifconfig veth0 10.1.1.1 up

./ip/ip netns exec netedge2 ifconfig veth7 up
./ip/ip netns exec netedge2 ifconfig veth7 10.1.1.2 up
...
echo "./ip/ip netns exec netedge1 ping 10.1.1.2 -I veth0"
